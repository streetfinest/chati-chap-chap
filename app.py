...
# Hili ndio badiliko kubwa: Vercel inaruhusu kuandika kwenye /tmp/uploads pekee
...
<head>
    ...
    <style>
        ...
        .msg-text { font-size: 16px; margin-top: 15px; user-select: text; -webkit-user-select: text; white-space: pre-wrap; word-wrap: break-word; color: #333; }
        .msg img { max-width: 100%; border-radius: 5px; margin-top: 10px; cursor: pointer; }
        .copy-btn { font-size: 12px; cursor: pointer; color: white; background: #075E54; border: none; padding: 5px 10px; border-radius: 4px; position: absolute; top: 10px; right: 10px; transition: 0.3s; }
